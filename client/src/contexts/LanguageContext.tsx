...
const translations = {
  es: {
    ...
    // Hero
    "hero.title": "Transforma tu comunicacion empresarial",
    "hero.subtitle": "Estrategias omnicanal con WhatsApp Business API que centralizan tus ventas y atencion al cliente, optimizando la experiencia del usuario y aumentando tu conversion.",
    "hero.bullet1": "35+ anos de experiencia asesorando empresas en transformacion digital",
    "hero.bullet2": "Especialista en WhatsApp Business API y comunicacion omnicanal",
    "hero.bullet3": "Alianzas con 14 Gremios en Colombia",
    "hero.cta1": "Agendar reunion",
    "hero.cta2": "Ver portafolio",
    "hero.stat1": "Anos de experiencia",
    "hero.stat2": "Horas de capacitacion",
    "hero.stat3": "Gremios en Colombia",
    
    // Services
    "services.badge": "Servicios",
    "services.title": "Soluciones integrales de omnicanalidad",
    "services.subtitle": "Desde la estrategia hasta la implementacion, te acompanamos en cada paso de tu transformacion digital.",
    "services.whatsapp.title": "WhatsApp Business API",
    "services.whatsapp.subtitle": "Escala tu atencion al cliente sin perder el toque humano",
    "services.whatsapp.desc": "Asesoramiento integral para la aprobacion e implementacion ante Meta. Diseno de estrategias personalizadas para maximizar el potencial de esta herramienta.",
    "services.digital.title": "Estrategias de comunicacion digital",
    "services.digital.subtitle": "Multiplica tu alcance con mensajes que convierten",
    "services.digital.desc": "Liderazgo en la creacion y ejecucion de campanas de comunicacion masiva para impulsar la facturacion, el reconocimiento de marca y la expansion a nuevos mercados.",
    "services.marketing.title": "Marketing digital y ventas",
    "services.marketing.subtitle": "Transforma tu equipo en maquinas de ventas",
    "services.marketing.desc": "Formacion y capacitacion de equipos comerciales en marketing digital, gerencia de ventas y desarrollo de nuevos productos.",
    ...
    "services.integration.desc": "Integracion de plataformas omnicanal y desarrollo de soluciones a medida, como bots de atencion al cliente y sistemas de pedidos.",
    ...
    "services.automation.desc": "Implementacion de automatizaciones inteligentes que reducen tiempos de respuesta y mejoran la eficiencia operativa.",
    "services.consulting.title": "Consultoria especializada",
    "services.consulting.subtitle": "Soluciones disenadas exclusivamente para ti",
    "services.consulting.desc": "Asesoria personalizada segun las necesidades especificas de tu empresa. Analisis profundo y soluciones a medida.",
    "services.learnMore": "Conocer mas",
    "services.ecosystem.title": "Tu ecosistema omnicanal completo",
    "services.ecosystem.subtitle": "No solo implementamos WhatsApp. Disenamos una estrategia integral que conecta todos tus canales de comunicacion en una experiencia unificada para tus clientes.",
    ...
    "services.ecosystem.item5": "Analisis y reportes",
    ...
    "experience.subtitle": "Mas de tres decadas transformando empresas a traves de estrategias digitales innovadoras.",
    "experience.alliances.title": "Alianzas estrategicas",
    "experience.alliances.subtitle": "35 anos de relaciones empresariales solidas",
    "experience.alliances.desc": "He establecido acuerdos comerciales a largo plazo con mas de 10 Camaras de Comercio en Colombia, incluyendo Barranquilla, Facatativa, Tunja y Cartago, asi como con grandes y medianas empresas del pais desde 1993.",
    "experience.tech.title": "Implementacion de tecnologia",
    "experience.tech.subtitle": "Experiencia con empresas Fortune 500",
    "experience.tech.desc": "Acompanamiento en la implementacion de Call Centers para clientes como Ssangyong Motor Colombia y la Camara de Comercio de Cali, asi como para concesionarios de la red Chevrolet.",
    "experience.teaching.title": "Docencia y consultoria",
    "experience.teaching.subtitle": "4000+ horas de capacitacion impartidas",
    "experience.teaching.desc": "Profesor universitario y consultor senior con vasta experiencia en la formacion de profesionales en areas de gerencia de ventas, marketing y creacion de nuevos productos.",
    "experience.whatsapp.title": "Especializacion WhatsApp",
    "experience.whatsapp.subtitle": "Especialista reconocido en omnicanalidad",
    "experience.whatsapp.desc": "Experto certificado en WhatsApp Business API con implementaciones exitosas en empresas de diversos sectores: retail, servicios, manufactura y educacion.",
    
    // Contact
    "contact.badge": "Contacto",
    "contact.title": "?Listo para transformar tu negocio?",
    "contact.subtitle": "Agendar una consulta es el primer paso. Te ayudare a disenar la estrategia omnicanal perfecta para tu empresa.",
    "contact.cta.title": "Consultoria para automatizar tu negocio",
    "contact.cta.subtitle": "Analiza tu situacion actual y descubre como WhatsApp Business API puede multiplicar tus ventas. Sesion de 30 minutos, sin compromiso.",
    ...
    "contact.social": "Siguenme en redes sociales",
    ...
    "footer.digitalTraining": "Capacitacion digital",
  ...
  en: {
    ...
    "experience.alliances.desc": "I have established long-term commercial agreements with more than 10 Chambers of Commerce in Colombia, including Barranquilla, Facatativa, Tunja, and Cartago, as well as with large and medium-sized companies in the country since 1993.",
